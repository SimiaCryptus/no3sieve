...
export class TopKPanel {
  constructor(el, { onSelect }) {
    ...
    if (typeof onSelect !== 'function')
      throw new TypeError('TopKPanel: onSelect callback is required');
    this.el = el;
  ...
  scan(ps, sizes, keep) {
    ...
    if (!Array.isArray(sizes) || !sizes.length)
      throw new TypeError('TopKPanel.scan: sizes must be a non-empty array');
